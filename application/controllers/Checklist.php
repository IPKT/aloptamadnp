...
class Checklist extends CI_Controller {
    ...
    public function history()
    {
        $data = array(
            ...
            'ta' =>$this->m_checklist->allData('tbl_taman_alat','tanggal , waktu'),
            'ak' =>$this->m_checklist->allData('tbl_aloptama_kantor','tanggal , waktu '),
            'sp' =>$this->m_checklist->allData('tbl_sistem_processing','tanggal , waktu '),
            'ji' =>$this->m_checklist->allData('tbl_jaringan_internet','tanggal, waktu '),
            // 'aloptama_kantor' =>$this->m_checklist->dataTerbaru('tbl_aloptama_kantor'),
            // 'sp' =>$this->m_checklist->dataTerbaru('tbl_sistem_processing'),
            // 'ji' =>$this->m_checklist->dataTerbaru('tbl_jaringan_internet'),
        );

       ...
       <?php echo form_open('lokasi/input')?>
        ...
        <div class="form-group">
            ...
            <select class = "form-control" id="" name="status_pm">
                <option value=""></option>
                <option value="sudah pm, on">Sudah PM, Kondisi ON</option>
                <option value="belum om, off">Belum PM, Kondisi OFF</option>
                <option value="sudah pm, off">Sudah PM, Kondisi OFF</option>
                <option value="belum pm, on">Belum Pm, Kondisi ON</option>
            </select>
        </div>

<div class="row">
    ...
    <div class="col-sm-4">
       ...
       <?php echo form_open_multipart('sosialisasi/input_data')?>
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="detail_lokasi" placeholder = "Detail Lokasi" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="jenis_kegiatan" placeholder = "Misalnya BGTS dll" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="jumlah_peserta" rows="5" placeholder="Jumlah Peserta" required>
        </div>
        <div class="form-group">
            <label for="">Gambar</label>
            <input class="form-control" name="gambar" type="file" required accept="image/*">
        </div>

<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <?php echo form_open_multipart("aloptama/input_data/$jenis_aloptama")?>
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="lokasi" placeholder="Lokasi" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="tipe" id="cars">
                ...
                <option value="Minireg">Minireg</option>
                <option value="Reis">Reis</option>
                <option value="CEA">CEA</option>
                <option value="BB 2021">BB 2021</option>
                <?php endif ?>
                <?php if ($jenis_aloptama == 'wrs'):?>
                <option value="WRS21">WRS 2021</option>
                <option value="WRS20">WRS 2020</option>
                <?php endif ?>
                <?php if ($jenis_aloptama == 'acc_noncolo'):?>
                <option value="Reis">Reis</option>
                <option value="Nanometric">Nanometric</option>
                <?php endif ?>

<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <?php echo form_open_multipart("aloptama/input_data_kunjungan/$jenis_aloptama")?>
        <div class="form-group">
            <label for="">Kode</label>
            <select class="form-control" name="id" id="cars">
        ...
        <div class="form-group">
            <label for="">File Laporan PM (PDF)</label>
            <input class="form-control" name="laporan" type="file" required
                accept="application/pdf,application/vnd.ms-word">
        </div>
        <div class="form-group">
            <label for="">Laporan 2 atau CM jika ada (PDF)</label>
            <input class="form-control" name="laporan2" type="file"
                accept="application/pdf,application/vnd.ms-word">
        </div>

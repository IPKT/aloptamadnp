<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <?php echo form_open_multipart('seismo/input_data_kunjungan')?>
        <div class="form-group">
            <label for="">Kode</label>
            <select class="form-control" name="id_seismo" id="cars">
        ...
        <div class="form-group">
            <label for="">Laporan 2 atau tambahan jika ada (PDF)</label>

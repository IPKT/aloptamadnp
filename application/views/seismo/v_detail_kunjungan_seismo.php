<div class="row">
    ...
    <div class="col-sm-6" style="margin-bottom: 20px;">
        ...
        $seismo = $CI->m_seismo->detail_seismo($lokasi->id_seismo)
        ?>
        <table class="table table-striped table-hover">
            <tbody>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?php $catatan = str_replace("\n", '<br />', $lokasi->catatan_kunjungan);
                    echo $catatan;?></td>
                </tr>
                <tr>
                    <td>Pelaksana</td>
                ...
                <tr>
                    ...
                    <td><?php 
                     $CI =& get_instance();
                     $CI->load->model('m_seismo');
                     $author = $CI->m_seismo->detail_user($lokasi->id_author);
                     if (isset($author)) {
                        echo $author->name;
                     }
    ...
    <div class="col-sm-12">
    <h2>Laporan PM</h2>
    <iframe src="<?=base_url('kunjungan_seismo/laporan/').$lokasi->laporan?>" height="500px" width="100%"
            title="Iframe Example"></iframe>
    </div>
    <div class="col-sm-12 <?php if ($lokasi->laporan2 ==NULL) {
        echo "hidden";
    }?>">
    <h2>Laporan 2</h2>
    <iframe src="<?=base_url('kunjungan_seismo/laporan/').$lokasi->laporan2?>" height="500px" width="100%"
            title="Iframe Example"></iframe>
    </div>

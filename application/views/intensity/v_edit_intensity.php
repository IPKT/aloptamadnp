<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <?php echo form_open_multipart('intensity/update_data')?>
        <div class="form-group">
            <label for="">Kode</label>
            <input disabled class="form-control" name="" placeholder=""
                value="<?=$intensity->kode?>">
        </div>
        <div class="form-group" hidden>
            <label for="">id Intensity</label>
            <input class="form-control" name="id" placeholder="Nama Lokasi" value="<?=$intensity->id_intensity?>"
                required>
        </div>
        <div class="form-group hidden">
            <label for="">Kode</label>

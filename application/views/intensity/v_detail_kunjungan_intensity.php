<div class="row">
    ...
    <div class="col-sm-6" style="margin-bottom: 20px;">
        ...
        $intensity = $CI->m_intensity->detail_intensity($lokasi->id_intensity)
        ?>
        <table class="table table-striped table-hover">
            <tbody>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?php if ($lokasi->catatan_kunjungan != NULL) {
                ...
                <tr>
                    ...
                    <td><?php 
                     $CI =& get_instance();
                     $CI->load->model('m_intensity');
                     $author = $CI->m_intensity->detail_user($lokasi->id_author);
                     if (isset($author)) {
                        echo $author->name;
                     }
    ...
    <span></span>
    <div class="col-sm-12">
        <iframe src="<?=base_url('kunjungan_intensity/laporan/').$lokasi->laporan?>" height="500px" width="100%"

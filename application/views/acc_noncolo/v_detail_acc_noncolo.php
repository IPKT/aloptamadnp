<div class="row">
    ...
    <div class="col-sm-5">
        ...
        <table class="table table-striped table-hover">
            <tbody>
                ...
                <tr>
                    <td>Detail Lokasi</td>
                    <td>:</td>
                    <td><?=$acc_noncolo->detail_lokasi?></td>
                </tr>
                <tr>
                    <td>Koordinat</td>
                    <td>:</td>
        ...
        <a href="<?=base_url('acc_noncolo')?>"><button class="btn btn-success">Pemetaan</button></a>
    </div>
...
<div class="table-responsive m-3">
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        $kunjungan = $CI->m_acc_noncolo->kunjungan_site_tertentu($acc_noncolo->kode); 
            ...
            <tr>
                ...
                <td>
                    <a class='btn btn-xs btn-success'
                        ...
                        Detail</a>
                    <a class='btn btn-xs btn-warning <?php if ($this->session->userdata('role_id') != 1 and $this->session->userdata('id_user') != $value->id_author )  {echo 'hidden';}?>' href='<?=base_url('acc_noncolo/edit/'.$value->id_kunjungan) ?>'>
                        Edit</a>
                    <a class='btn btn-xs btn-danger <?php if ($this->session->userdata('role_id') == 2) {echo 'hidden';}?>' onclick="del('<?=base_url('acc_noncolo/delete_kunjungan/'.$value->id_kunjungan) ?>' , '<?=$value->kode?>')"> Delete</a>
                </td>
            </tr>
            <?php }?>
        </tbody>

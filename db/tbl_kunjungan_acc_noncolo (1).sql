...
--
-- Table structure for table `tbl_kunjungan_acc_noncolo`
--

CREATE TABLE `tbl_kunjungan_acc_noncolo` (
...
--
-- Indexes for table `tbl_kunjungan_acc_noncolo`
--
ALTER TABLE `tbl_kunjungan_acc_noncolo`
...
--
-- AUTO_INCREMENT for table `tbl_kunjungan_acc_noncolo`
--
ALTER TABLE `tbl_kunjungan_acc_noncolo`
